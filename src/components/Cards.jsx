...
const Cards = () => {
  ...
  const styles = {
    ...
    title: {
      fontSize: 'clamp(3.5rem, 10vw, 8.5rem)', // Responsive huge font
      fontWeight: '900',
      lineHeight: '0.85',
      letterSpacing: '-5px',
      margin: '0 0 30px 0',
      ...
      <div style={styles.grid}>
        {cards.map((card) => (
          <div 
            ...
            onMouseEnter={(e) => e.currentTarget.style.transform = 'rotate(0deg) scale(1.05) translateY(-10px)'}
            onMouseLeave={(e) => e.currentTarget.style.transform = `rotate(${card.rotate}) scale(1)`}
          >
            {card.type === 'metric' ? (
              ...
              <div style={{ width: '100%', height: '100%' }}>
                {/* Tumi ekhane video file upload korbe */}
                <video 
                  src="" 
